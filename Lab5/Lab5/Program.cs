...
namespace Lab5
{
     public class Program
    {
        ...
        {
            Student student1 = new Student("Jan", "Kowalski", new DateTime(1995, 1, 1),
            "Informatyka", 1, 1, 123123);
            Student student2 = new Student("Piotr", "Nowak", new DateTime(1990, 1, 1),
            "Matematyka", 3, 2, 321312);
            Person student3 = new Student("Adam", "Bedrnarski", new DateTime(1993, 1, 1),
            "Informatyka", 1, 2, 765123);
            ...
            Lecturer lecturer1 = new Lecturer("Krzysztof", "Nowakowski", new DateTime(1978, 12,
            12), "dr inż.", "Adiunkt");
            Lecturer lecturer2 = new Lecturer("Jan", "Kowalski", new DateTime(1960, 10, 12),
            "Prof. dr hab. inż.", "Profesor");
            Lecturer lecturer3 = new Lecturer("Adam", "Nowakowski", new DateTime(1968, 2, 12),
            "dr inż.", "Adiunkt");
            Lecturer lecturer4 = new Lecturer("Arkadiusz", "Bednarski", new DateTime(1969, 1,
            12), "dr hab. inż.", "Profesor");
            OrganizationUnit organizationUnit1 = new OrganizationUnit("Instytut Informatyki

            Teoretycznej i Stosowanej", "Częstochowa", new List<Lecturer>());

            OrganizationUnit organizationUnit2 = new OrganizationUnit("Instytut Inteligentnych

            Systemów Informatycznych", "Częstochowa", new List<Lecturer>());
            ...
            Lecturer dean = new Lecturer("Tadeusz", "Nowak", new DateTime(1955, 1, 12), "Prof. dr

            hab.inż.", "Profesor");

            Department department = new Department("Wydział Inżynierii Mechanicznej i

            Informatyki", dean, new List<Subject>(), new List<Student>());
